...
<div>
 <div id="carouselExampleDark" className="carousel hero-bg carousel-dark slide">
    ...
    <div className="carousel-inner py-5">
      {
        ...
        <div className="container">
            <div className="row justify-content-center">
             ...
             <h1 className="headline-1 mt-5">{item['title']}</h1>
             <p>{item['des']}</p>
             <Link to="" className="btn text-white btn-success px-5">Event Details</Link>
             </div>
             <div className="col-12 col-lg-5 col-sm-12 col-md-5 p-5">
    ...
    <button className="carousel-control-next btn" type="button" 
